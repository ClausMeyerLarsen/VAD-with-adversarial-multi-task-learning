...
class VAD_model(nn.Module):
    def __init__(self):
        ...
        self.EB2 = nn.Conv1d(30,15,160,stride=1,padding='same')
        ...
        self.EB3 = nn.Conv1d(15,7,160,stride=1,padding='same')
        ...
        self.EB4 = nn.Conv1d(7,2,160,stride=1,padding='same')
        ...
        self.DN1 = nn.Conv1d(2,2,55,stride=1,padding='same', groups=1)
        torch.nn.init.xavier_normal_(self.DN1.weight)
        self.sigmoidDN1 = nn.Sigmoid()
        self.drop6 = nn.Dropout(p=0.2)
        
        self.DN2 = nn.Conv1d(2,2,15,stride=1,padding='same', groups=1)
        torch.nn.init.xavier_normal_(self.DN2.weight)
        self.sigmoidDN2 = nn.Sigmoid()
        self.drop7 = nn.Dropout(p=0.2)
        
        self.DN3 = nn.Conv1d(2,5,5,stride=1,padding='same', groups=1)
